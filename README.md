...
**A comprehensive sovereign infrastructure ecosystem featuring CTF Brain (AI-powered penetration testing orchestration), Discord-integrated DevOps automation, and sovereign infrastructure management.**
...
# Run proxy module
docker run -it ctf-brain python /app/netcat_proxy.py
```
...
# With coverage
pytest tests/ --cov=src/ctf-brain --cov-report=html
```
...
1. Add new methodology nodes to `src/ctf-brain/methodology_graph.json`
...
# 🏛️ Sovereignty Architecture - Discord DevOps Control Plane
