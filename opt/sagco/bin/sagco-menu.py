...
SAGCO_ROOT = path.dirname(SCRIPT_DIR)
SPM_PATH = path.join(SAGCO_ROOT, "spm.yml")
STATE_PATH = path.join(SAGCO_ROOT, "menu_state.json")  # Recently used (global for v1; per-user future)
