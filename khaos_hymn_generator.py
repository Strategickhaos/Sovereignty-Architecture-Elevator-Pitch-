...
def generate_midi_file(output_path="khaos_hymn.mid"):
    ...
    for glyph_id, glyph, theta, midi_note, family in GLYPHS:
        ...
        # Using exact equality since glyphs are at precise angles
        if theta == 90.0 or theta == 180.0 or theta == 270.0:
            velocity = min(127, velocity + 20)  # Crescendo
        
        # Track total duration for accurate measurement
    ...
    try:
        ...
        print(f"  Duration: ~{total_duration_ticks / 480:.1f} measures")
        return True
