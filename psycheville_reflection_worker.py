...
- [[{dept_name} Archive]]
- [[Weekly Synthesis {datetime.utcnow().strftime('%Y-W%U')}]]

## 📝 Tags

#psycheville #daily-report #{department.replace('_', '-')} #{datetime.utcnow().strftime('%Y-%m-%d')}
...
---
*Last refresh: {datetime.utcnow().strftime('%Y-%m-%d %H:%M:%S')} UTC*
"""
