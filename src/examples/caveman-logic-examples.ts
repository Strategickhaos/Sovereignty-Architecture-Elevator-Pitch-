...
const goodConcept = CavemanLogic.doesItCompute(
  false, true, true, true, true
);
console.log(`Good concept computes: ${goodConcept}`);

const badConcept = CavemanLogic.doesItCompute(
  true,  // ❌ Requires free energy
  true, true, true, true
);
