...
function extractSemanticRoot(input) {
...
function analyzeWaveform(codes) {
...
function validateGrounding(original, semantic) {
    const checks = [];
...
function lookupDemystification(input) {
...
export function demystify(input) {
