 ...
 */
export function convertToMidiTiming(notation) {
 ...
 */
export function groupByFamily(notation) {
    const grouped = {};
 ...
 */
export function calculateStats(notation) {
    ...
    const familyCounts = Object.fromEntries(Object.keys(notation.families).map(family => [
        family,
