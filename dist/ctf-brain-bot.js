 ...
 */
export async function handleCTFBrainCommand(interaction) {
...
async function handleNodeCommand(interaction) {
    ...
    const embed = new EmbedBuilder()
        ...
        .addFields({ name: '🧩 PLL Algorithm', value: node.pll_analog, inline: false }, { name: '🛠️ Tools', value: node.tools.join(', '), inline: false }, { name: '🎯 Triggers', value: node.triggers.join(', '), inline: false }, { name: '📊 Expected Output', value: node.expected_output.join(', '), inline: false })
        .setTimestamp();
...
async function handlePathCommand(interaction) {
...
async function handleInfoCommand(interaction) {
    ...
    const embed = new EmbedBuilder()
        ...
        .addFields({ name: '👤 Author', value: metadata.author, inline: false }, { name: '🧠 Philosophy', value: metadata.philosophy, inline: false }, { name: '📊 Statistics', value: `Nodes: ${nodeCount} | Edges: ${edgeCount}`, inline: false }, { name: '⚖️ Quadrant Weights', value: `Tool Ready: ${weights.tool_ready}\n` +
