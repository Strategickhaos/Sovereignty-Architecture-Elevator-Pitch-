 ...
 * Parse UDAP URI
 */
export function parseUDAPUri(uri) {
    try {
 ...
 * Build UDAP URI
 */
export function buildUDAPUri(route) {
 ...
 */
export async function routeUDAP(uri) {
 ...
 */
async function handleTCPRoute(route) {
 ...
 */
async function handleBrowserRoute(route) {
 ...
 */
async function handleCompilerRoute(route) {
 ...
 */
async function handleAlphaDNARoute(route) {
 ...
 */
async function handleProteinRoute(route) {
 ...
 */
async function handleCollapseRoute(route) {
 ...
 */
async function handleHybridRoute(route) {
    return {
        success: true,
        result: {
 ...
 */
export function generateCLIRoute(commandName, frequencyHz, params = {}) {
    const categoryMap = {
