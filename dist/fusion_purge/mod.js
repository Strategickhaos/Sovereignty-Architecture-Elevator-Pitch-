...
export var PurityLevel;
(function (PurityLevel) {
    PurityLevel[PurityLevel["LEGACY"] = 0] = "LEGACY";
    PurityLevel[PurityLevel["HYBRID"] = 50] = "HYBRID";
    PurityLevel[PurityLevel["PURE"] = 100] = "PURE"; // Zero lock-in achieved
